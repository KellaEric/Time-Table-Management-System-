            ...
            <div style="display:none" id="addSubjectForm">
                <form action="addsubjectFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="subjectcode" name="SC" placeholder="CPS, MESSLA, MDL, HCM...">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="subjectdepartment">DEPARTMENTS</label>
                        <select class="form-control" id="subjectdepartment" name="SD">
                            <option selected disabled>Select</option>
                            <option value="Computer scinece.">Computer Science (CPS).</option>
                            <option value="marketing.">Purchasing and Supply.</option>
                             <option value="hcm.">HCM.</option>
                            <option value="medical laboratory.">Medical Laboratory (MEDLA).</option>
                             <option value="mesla.">MESLA.</option>
                            <option value="Fashion.">Fashion .</option>
                            <option value="Civil Engg.">Civil Engineering.</option>
                            <option value="Electrical Engg.">Electrical Engineering.</option>
                            <option value="Mechanical Engg.">Auto Mechanical Enginerring.</option>
                        </select>
                    </div>
