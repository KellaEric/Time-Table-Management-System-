...
<head>
    ...
    <title> Accra Technical University TimeTable Management System</title>
...
<div id="myModal" class="modal">
    ...
    <!-- Modal content -->
    <div class="modal-content" style="margin-top:fixed">
        <div class="modal-header">
            <span class="close">&times</span>
            <h2 id="popupHead">Add Lecturer</h4>
                 <p style="background-color: red; display: flex; color:black"> Please do well to input the valid requirements!</p>
        </div>
        <div class="modal-body" id="EnterTeacher">
            <!--Admin Login Form-->
            <div style="display:non" id="addTeacherForm">
 ...
 -->
                        <select class="form-control" id="designation" name="TD">
                            ...
                            <option value="Assistant Professor">TA </option>
...
<div>
    ...
    <table id=teacherstable style="margin-left: 60px">
