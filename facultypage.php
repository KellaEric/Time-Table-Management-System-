...
<form action="facultypage.php" method="post">
    <div align="center" style="margin-top: 10px">
        <select name="select_semester" class="list-group-item">
            ...
            <option value="Btech1">BTech1</option>
            <option value="Btech2">BTech2</option>
            <option value="Btech3">BTech3</option>
            <option value="Btech4">BTech4</option>
            <option value="7HND I">HND I</option>
        ...
        <table border="2" cellspacing="3" align="center" id="timetable">
            <caption><strong><br><br>
                    ...
                    if (isset($_POST['select_semester'])) {
                        echo "DEPARTMENT COMPUTER SCIENCE (CPS2) " . $_POST['select_semester'] . " ";
                        $year = (int)($_POST['select_semester'] / 20) + $_POST['select_semester'] % 20;
            ...
            <tr>
                ...
                <td style="text-align:center">7:00am-10:00am</td>
                <td style="text-align:center">11:00am-1:00pm</td>
                <td style="text-align:center">2:00pm-4:00pm</td>
